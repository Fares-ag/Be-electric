                    ...
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [AppTheme.accentGreen, AppTheme.primaryColor],
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isSelected
                    ? AppTheme.accentGreen.withValues(alpha: 0.1) // Be Electric brand green
                    : Colors.transparent,
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                  color: isSelected
                      ? AppTheme.accentGreen.withValues(alpha: 0.3) // Be Electric brand green
                      : Colors.transparent,
                ),
              ),
              child: _isSidebarCollapsed
                  ? Center(
                      child: Icon(
                        ...
                        color: isSelected
                            ? AppTheme.accentGreen // Be Electric brand green
            ...
            PopupMenuButton<String>(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    radius: 20,
                    backgroundColor: AppTheme.accentGreen.withValues(alpha: 0.1), // Be Electric brand green
                    child: Text(
