...
class AssetSelectionScreen extends StatefulWidget {
  ...
  final int initialTab; // 0 = Search, 1 = Manual
...
class _AssetSelectionScreenState extends State<AssetSelectionScreen>
  ...
  void initState() {
    ...
    _tabController = TabController(
      length: 2,
      vsync: this,
      initialIndex: widget.initialTab >= 2 ? 1 : widget.initialTab,
    );
    _loadAssets();
  }
              ...
              TabBar(
                ...
                tabs: [
                  Tab(
                    ...
                    text: isDesktop ? 'Search Assets' : 'Search',
                  ),
                  Tab(
                    icon: Icon(Icons.keyboard),
                    text: isDesktop ? 'Enter Asset ID' : 'Enter ID',
                  ),
                ],
              ),
              Expanded(
