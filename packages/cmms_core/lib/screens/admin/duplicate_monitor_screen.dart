...
class _DuplicateMonitorScreenState extends State<DuplicateMonitorScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final woResponse =
          await client.from('work_orders').select().neq('idempotencyKey', '');
      ...
      final pmResponse =
          await client.from('pm_tasks').select().neq('idempotencyKey', '');
        ...
        child: ListTile(
          ...
          trailing: Container(
            ...
            child: Text(
              '$count',
              style: TextStyle(
                color: count == 0 ? AppTheme.accentGreen : AppTheme.accentRed,
