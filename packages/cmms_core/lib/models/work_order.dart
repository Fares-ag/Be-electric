...
class WorkOrder {
  WorkOrder({
    ...
    this.previousStatus,
        ...
        technicianEffortMinutes = technicianEffortMinutes != null
            ...
            : null,
        photoPaths = photoPaths ?? (photoPath != null ? [photoPath] : null),
        completionPhotoPaths = completionPhotoPaths ??
            (completionPhotoPath != null ? [completionPhotoPath] : null);
  ...
  factory WorkOrder.create({
    ...
    return WorkOrder(
      ...
      photoPath: photoPath,
      photoPaths: photoPath != null ? [photoPath] : null,
      priority: priority,
      category: category,
      notes: notes,
    );
  }
  factory WorkOrder.fromMap(Map<String, dynamic> data) {
    String? resolveAssetId() {
      final top = data['assetId'] as String?;
      if (top != null && top.isNotEmpty) {
        return top;
      }
      final meta = data['metadata'];
      if (meta is Map) {
        final app = meta['appAssetId'];
        if (app != null) {
          final s = app.toString();
          if (s.isNotEmpty) {
            return s;
          }
        }
    ...
    String? resolveCompanyId() {
      final top = data['companyId'] as String?;
      if (top != null && top.isNotEmpty) {
        return top;
      }
      final meta = data['metadata'];
      if (meta is Map) {
        final app = meta['appCompanyId'];
        if (app != null) {
          final s = app.toString();
          if (s.isNotEmpty) {
            return s;
    ...
    return WorkOrder(
        ...
        photoPaths: _parseStringList(data['photoPaths']) ??
            (data['photoPath'] != null ? [data['photoPath'] as String] : null),
        ...
        completionPhotoPaths: _parseStringList(data['completionPhotoPaths']) ??
            (data['completionPhotoPath'] != null
                ? [data['completionPhotoPath'] as String]
                : null),
        ...
        // Reopen tracking fields
        reopenedAt: _parseDate(data['reopenedAt']),
        reopenedBy: data['reopenedBy'] as String?,
        reopenReason: data['reopenReason'] as String?,
        reopenCount: (data['reopenCount'] as num?)?.toInt() ?? 0,
        previousCompletionDate: _parseDate(data['previousCompletionDate']),
  ...
  final String?
      photoPath; // Deprecated: use photoPaths instead, kept for backward compatibility
  final List<String>? photoPaths; // Multiple photo URLs
  ...
  final DateTime? previousCompletionDate;
  final WorkOrderStatus? previousStatus;
  ...
  WorkOrder copyWith({
    ...
    String? reopenReason,
    int? reopenCount,
    DateTime? previousCompletionDate,
    WorkOrderStatus? previousStatus,
      ...
      WorkOrder(
        ...
        completionPhotoPaths:
            completionPhotoPaths ?? this.completionPhotoPaths,
        ...
        previousCompletionDate:
            previousCompletionDate ?? this.previousCompletionDate,
  ...
  bool get isReopened => status == WorkOrderStatus.reopened;
  ...
  Map<String, dynamic> toMap() => {
        ...
        'photoPaths': photoPaths, // Multiple photo URLs
        'primaryTechnicianId': primaryTechnicianId ??
        ...
        'previousCompletionDate': previousCompletionDate?.toIso8601String(),
