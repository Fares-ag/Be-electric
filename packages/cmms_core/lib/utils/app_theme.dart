...
class AppTheme {
  ...
  /// Work order lifecycle — each status has a unique badge color.
  static const Color workOrderStatusOpen = Color(0xFF1565C0);
  static const Color workOrderStatusAssigned = Color(0xFFEF6C00);
  static const Color workOrderStatusInProgress = Color(0xFF6A1B9A);
  static const Color workOrderStatusCompleted = Color(0xFF2E7D32);
  static const Color workOrderStatusClosed = Color(0xFF455A64);
  static const Color workOrderStatusCancelled = Color(0xFFC62828);
  static const Color workOrderStatusReopened = Color(0xFF00695C);
  static const Color workOrderStatusPaused = Color(0xFFFF8F00);

  /// PM task — distinct from work-order colors to avoid confusion on mixed screens.
  static const Color pmTaskStatusPending = Color(0xFF5E35B1);
  static const Color pmTaskStatusInProgress = Color(0xFF0277BD);
  static const Color pmTaskStatusCompleted = Color(0xFF33691E);
  static const Color pmTaskStatusOverdue = Color(0xFFB71C1C);
  static const Color pmTaskStatusCancelled = Color(0xFF616161);
  ...
  // Deprecated: Use accentGreen instead (Be Electric brand color)
  @Deprecated('Use accentGreen for Be Electric brand color')
  static const Color green = accentGreen;
  // Deprecated: Use accentRed instead
  @Deprecated('Use accentRed instead')
  static const Color red = accentRed;
  // Deprecated: Use accentOrange instead
  @Deprecated('Use accentOrange instead')
  static const Color orange = accentOrange;
  // Deprecated: Use accentBlue instead
  @Deprecated('Use accentBlue instead')
  ...
  static const InputDecoration inputDecoration = InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(
      borderSide: BorderSide(color: accentGreen), // Be Electric brand green
      borderRadius: BorderRadius.all(Radius.circular(8)),
    ),
    filled: true,
  ...
  // Button Styles
  // Primary button uses Be Electric brand green
  static const ButtonStyle elevatedButtonStyle = ButtonStyle(
    backgroundColor: WidgetStatePropertyAll(accentGreen),
  ...
  static const ButtonStyle outlinedButtonStyle = ButtonStyle(
    foregroundColor: WidgetStatePropertyAll(accentGreen),
    side: WidgetStatePropertyAll(BorderSide(color: accentGreen)),
    padding: WidgetStatePropertyAll(
      EdgeInsets.symmetric(horizontal: 24, vertical: 12),
    ),
    shape: WidgetStatePropertyAll(
  ...
  static const Color infoColor = accentGreen; // Be Electric brand green

  static ThemeData get lightTheme => ThemeData(
        useMaterial3: true,
        fontFamily: 'Suisse Int\'l',
        colorScheme: ColorScheme.fromSeed(
          seedColor: accentGreen, // Be Electric brand green
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            backgroundColor: accentGreen, // Be Electric brand green
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(8),
            borderSide: const BorderSide(color: accentGreen), // Be Electric brand green
          ),
  ...
  /// Unique color per [WorkOrderStatus] for chips, lists, and detail headers.
  static Color workOrderStatusColor(WorkOrderStatus status) {
    switch (status) {
      case WorkOrderStatus.open:
        return workOrderStatusOpen;
      case WorkOrderStatus.assigned:
        return workOrderStatusAssigned;
      case WorkOrderStatus.inProgress:
        return workOrderStatusInProgress;
      case WorkOrderStatus.completed:
        return workOrderStatusCompleted;
      case WorkOrderStatus.closed:
        return workOrderStatusClosed;
      case WorkOrderStatus.cancelled:
        return workOrderStatusCancelled;
      case WorkOrderStatus.reopened:
        return workOrderStatusReopened;
    }
  }

  static Color pmTaskStatusColorFromEnum(PMTaskStatus status) {
    switch (status) {
      case PMTaskStatus.pending:
        return pmTaskStatusPending;
      case PMTaskStatus.inProgress:
        return pmTaskStatusInProgress;
      case PMTaskStatus.completed:
        return pmTaskStatusCompleted;
      case PMTaskStatus.overdue:
        return pmTaskStatusOverdue;
      case PMTaskStatus.cancelled:
        return pmTaskStatusCancelled;
    }
  }

  // String-based status (lists, API names, asset workflow states, etc.)
