-- Align upsert_work_order with Flutter photo contract:
-- Top-level: photoPath, completionPhotoPath (+ legacy before/after if sent)
-- metadata: photoPaths, completionPhotoPaths (full lists; merged on conflict)
