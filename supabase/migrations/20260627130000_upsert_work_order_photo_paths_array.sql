-- Flutter may send multiple request photos as photoPaths[] (array) rather than photoPath (string).
-- Persist as JSON text in photoPath, matching the web request form convention.
