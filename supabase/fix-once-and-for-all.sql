-- ============================================================
-- PREFER MIGRATION: Use supabase db push (or run migrations).
-- This file mirrors: migrations/20260311150000_admin_rpc_and_all_grants.sql
-- Run this only if you are NOT using migrations (e.g. Dashboard SQL Editor).
-- ============================================================

-- ── 1. get_admin_by_email RPC (bypasses admin_users table access)
...
-- ── 2. GRANT ALL on every table in public schema
...
-- ── 3. get_my_role() – check admin_users FIRST (for RLS policies)
