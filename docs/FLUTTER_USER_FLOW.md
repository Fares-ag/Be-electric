...
**Context:** This document describes how users (Requestor and Technician) move through the Flutter app so the React admin can stay aligned on auth, roles, and data usage. Copy or paste into the React Cursor as needed. (Source: Flutter Cursor project.)
